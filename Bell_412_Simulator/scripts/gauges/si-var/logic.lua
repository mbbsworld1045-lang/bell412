...
-- ---- ALTIMETER: BUG ----
local function alt_bug_callback(direction)
    if direction == 1 then
        alt_bug = alt_bug + 50
    elseif direction == -1 then
        alt_bug = alt_bug - 50
    end
    alt_bug = var_cap(alt_bug, 0, 20000)
    si_variable_write(si_alt_bug, alt_bug)
    print("SENDER Alt Bug: " .. alt_bug .. " ft")
end

-- ---- RADAR ALTIMETER: BUG ----
local function radalt_bug_callback(direction)
    if direction == 1 then
        radalt_bug = radalt_bug + 10
    elseif direction == -1 then
        radalt_bug = radalt_bug - 10
    end
    radalt_bug = var_cap(radalt_bug, 0, 1500)
    si_variable_write(si_radalt_bug, radalt_bug)
    print("SENDER RadAlt Bug: " .. radalt_bug .. " ft")
end
...
hw_dial_add("ARDUINO_MEGA2560_G_D52", "ARDUINO_MEGA2560_G_D17", "TYPE_1_DETENT_PER_PULSE", adi_cage_callback)
-- ADI Right - Left Encoder (Heading Knob): D14 & A15
hw_dial_add("ARDUINO_MEGA2560_G_D14", "ARDUINO_MEGA2560_G_A15", "TYPE_1_DETENT_PER_PULSE", adi_heading_callback)
...
hw_dial_add("ARDUINO_MEGA2560_G_D12", "ARDUINO_MEGA2560_G_D13", "TYPE_1_DETENT_PER_PULSE", adi_heading_callback)

-- ---- HSI Encoders ----
-- HSI Right - Right Encoder (Heading Bug): A13 & A14
hw_dial_add("ARDUINO_MEGA2560_G_A13", "ARDUINO_MEGA2560_G_A14", "TYPE_1_DETENT_PER_PULSE", hsi_bug_callback)
...
hw_dial_add("ARDUINO_MEGA2560_G_A4", "ARDUINO_MEGA2560_G_D9", "TYPE_1_DETENT_PER_PULSE", hsi_bug_callback)
-- HSI Left - Left Encoder (OBS Needle): D7 & DUMMY D13 (replace D13 when known)
hw_dial_add("ARDUINO_MEGA2560_G_D7", "ARDUINO_MEGA2560_G_D13", "TYPE_1_DETENT_PER_PULSE", hsi_obs_callback)
...
hw_dial_add("ARDUINO_MEGA2560_G_D15", "ARDUINO_MEGA2560_G_D16", "TYPE_1_DETENT_PER_PULSE", alt_bug_callback)
-- Alt Meter Left: A7 & D8
hw_dial_add("ARDUINO_MEGA2560_G_A7", "ARDUINO_MEGA2560_G_D8", "TYPE_1_DETENT_PER_PULSE", alt_bug_callback)
