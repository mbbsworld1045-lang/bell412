-- =============================================================================
-- BELL 412 - CDI (Course Deviation Indicator) / VOR Gauge
-- Encoder (Channel G):
--   CDI Right: D18 & A12 = OBS Compass Ring
-- =============================================================================
...
-- =============================================================================
-- ENCODER INPUT (Channel G) - CDI Right: D18 & A12
-- =============================================================================
hw_dial_add("ARDUINO_MEGA2560_G_D18", "ARDUINO_MEGA2560_G_A12", "TYPE_1_DETENT_PER_PULSE", function(direction)
    current_obs_position = current_obs_position + (direction * 5)
    current_obs_position = current_obs_position % 360

    -- Directly rotate compass ring for instant feedback
    ...
    print("CDI OBS: " .. (direction == 1 and "CW" or "CCW") .. " -> " .. current_obs_position .. " deg")
end)
