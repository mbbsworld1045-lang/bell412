...
local PINS_D = {
    ...
    -- CONFIICTS RESOLVED:
    -- DOME (D22) -> CB_GEN1_RESET
    -- UTIL (D23) -> CB_IGNITION1
    -- FIRE1 (D24) -> CB_IDLE_STOP
    -- FIRE2 (D25) -> Unused/Cleared
    -- FIRE_TEST (D26) -> CB_ITT1
    -- LED_GEN1_FAIL (D30) -> CB_NON_ESS2
    -- LED_BATT_CAUT (D34) -> CB_INV1
    -- LED_FIRE2 (D36) -> BLOWER
    -- LED_BAG_FIRE (D37) -> AFT_OUTLET
    -- Commenting out legacy conflicted pins:
    ...
    -- Output LEDs (Legacy - Commented out where conflicted)
    -- LED_GEN1_FAIL = "ARDUINO_MEGA2560_D_D30", -- CONFLICT D30
    LED_GEN2_FAIL = "ARDUINO_MEGA2560_D_D31",
    LED_INV1_FAIL = "ARDUINO_MEGA2560_D_D32",
    LED_INV2_FAIL = "ARDUINO_MEGA2560_D_D33",
    -- LED_BATT_CAUT = "ARDUINO_MEGA2560_D_D34", -- CONFLICT D34
    LED_FIRE1 = "ARDUINO_MEGA2560_D_D35",
    -- LED_FIRE2 = "ARDUINO_MEGA2560_D_D36", -- CONFLICT D36
    -- LED_BAG_FIRE = "ARDUINO_MEGA2560_D_D37", -- CONFLICT D37
}
