...
function update_cwp_leds()
    ...
    hw_output_set(LEDS_E.GOV_MANUAL_L, check(STATE.SwGovA ~= 0, true))
    ...
    hw_output_set(LEDS_E.INVERTER_1_L, check(STATE.Swinva == 0, true))
    hw_output_set(LEDS_E.HEATER_AIR_L, check(STATE.SwHeater ~= 0, true))
    ...
    hw_output_set(LEDS_E.FUEL_TRANS_2_R, check(STATE.SwfueltransengB == 0, true))
